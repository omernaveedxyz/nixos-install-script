...
in
{
  ...
  testScript = ''
    ...
    machine.fail("echo y | ${install-script}/bin/install.sh --hostname /dev/vda")
    machine.fail("echo y | ${install-script}/bin/install.sh --hostname=test- /dev/vda")
    machine.fail("echo y | ${install-script}/bin/install.sh --hostname=test?vm /dev/vda")
    machine.fail("echo y | ${install-script}/bin/install.sh --hostname= /dev/vda")

    machine.fail("echo y | ${install-script}/bin/install.sh")
    machine.fail("echo y | ${install-script}/bin/install.sh /dev/sda")
    machine.fail("echo y | ${install-script}/bin/install.sh /dev/sda /dev/vda")

    machine.succeed(
      "echo y | ${install-script}/bin/install.sh /dev/vda",
